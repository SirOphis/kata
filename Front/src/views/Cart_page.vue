                ...
                <div class="row border-bottom py-2" v-for="(carts, index) in cart" :key="index">
                    <div class="col-md-6">
                        <div class="d-flex justify-content-start cart-img">
                            <img class="" :src="carts.product.imageUrl">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="d-flex  align-items-center justify-content-between">
                            <div  style="text-align: end; width: 100px;">
                                ...
                                <p style="font-size: 12px; margin: 0">Total $ {{ carts.total_product_price.toFixed(2) }}</p>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column cart-total-container" style="gap: 5px;">
                        ...
                        <div class="d-grid col">
                            <button class="btn btn-dark" type="button" @click="cart_store.complete_buy()">Proceed to Checkout</button>
                        </div>
                    </div>
            </div>
