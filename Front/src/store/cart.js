...
export const useCartStore = defineStore('useCartStore', () => {
    ...
    return{carts, add_cart, loadFromLocalStorage, cart_show, totalQuantity, increment_quantity, decrement_quantity, remove_cart, prd_detail_add_cart, complete_buy, total_price,clear_cart }
})